...
> **🔑 维护者授权（2026-09-08 Round 3，原始回答）**：就「18 个未打标签 issue 如何分流」的提问，维护者选择 **“授权安装缺失依赖（axios/qrcode/rxjs 等）”**，并附加自定义说明 **“但注意”**（内容被截断，**具体注意事项待澄清后再动 package.json / lockfile**）。因此：**#32/#20/#226/#13 等未打标签 issue 仍未获标签，暂不派发**；依赖安装须等澄清 + 走主树安装 + junction 复验流程（见 §8）。
