...
> 规律（36 对旧组合 + 45 对 Round 11 复算验证）：**占位符行相距 1 行 → 冲突；相距 ≥2 行 → 自动合并**。integrations 的占用行：#504 useAsyncValidator=9、#503 useAxios=10、#502 useCookies=12、#114 useDrauu=13、#498 useFuse=15、#501 useIDBKeyval=16、#497 useJwt=17、#499 useNProgress=18、#500 useQRCode=19、#209 useSortable=20；shared 的 #494=13/#496=16（行距 3 ⇒ 不冲突）；electron 的 #148+#149+#150=8-10 与 #256+#257=11-12（行距 1 ⇒ 合并后必然冲突，须用 `.agents/update-branch-any.ps1`，因为 `scripts/update-branch.sh:82` 不认 electron）；rxjs 的 #42=9 与 #262=14（行距 5 ⇒ 不冲突）。
